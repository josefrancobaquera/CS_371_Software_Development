/**
   ...
   Purpose of File: Implements a base abstract class for a circle. Everything except 
...
{
   radius = radius*factor; // Error found on this line. Changed by Jose Franco Baquera.
   return radius;
}
...
public Point moveBy(double xOffset, double yOffset)
{
   ...
   center.y = center.y + yOffset; // Error found on this line. Changed by Jose Franco Baquera.
   return center;
}
